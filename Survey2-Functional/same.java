...
public class same {
    ...
    /*
	Referrential transparency: This function does not reference any 
	variables outside the scope
	of the function, and it does not modify the list passed to it. 
	Therefore, it is referrentially transparent.
    */
    public static <e> boolean same(List<e> list1, List<e> list2) {
		if (list1.isEmpty() && list2.isEmpty()) return true;
		    ...
		    return same(list1.subList(1, list1.size()), 
